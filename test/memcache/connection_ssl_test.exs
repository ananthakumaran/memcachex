defmodule Memcache.ConnectionSSLTest do
  @moduledoc false
  ...
  test "named process" do
    {:ok, pid} =
      start_link(
        [port: 31_211, hostname: "localhost", ssl: true, ssl_options: [verify: :verify_none]],
        name: :memcachex
      )
  ...
  test "reconnects automatically" do
    {:ok, pid} = start_link(port: 31_211, ssl: true, ssl_options: [verify: :verify_none])
    down("memcache")
    :timer.sleep(100)
    up("memcache")
    :timer.sleep(1000)
